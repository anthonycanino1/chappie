...
# for bench_dir in $current_data_root/*; do
  bench_dir=../chappie-data/2020/precision/sunflow
...
bench_dir=../chappie-data/2020/precision/h2
for case_dir in $bench_dir/*; do
  for work_dir in $case_dir/*; do
    echo $work_dir
    python3 src/python/analysis -d $work_dir &
...
bench_dir=../chappie-data/2020/precision/pmd
for case_dir in $bench_dir/*; do
  for work_dir in $case_dir/*; do
    echo $work_dir
    python3 src/python/analysis -d $work_dir &
...
bench_dir=../chappie-data/2020/precision/tomcat
for case_dir in $bench_dir/*; do
  for work_dir in $case_dir/*; do
    echo $work_dir
    python3 src/python/analysis -d $work_dir &
