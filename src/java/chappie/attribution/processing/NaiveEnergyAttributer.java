...
public final class NaiveEnergyAttributer implements EnergyAttributer<NaiveEnergyAttribution> {
  private Instant lastTimestamp;
  private ArrayList<NaiveEnergyAttribution> attributions = new ArrayList<>();
  ...
  @Override
  public Iterable<NaiveEnergyAttribution> process() {
    ArrayList<NaiveEnergyAttribution> attributions;
    synchronized (this) {
