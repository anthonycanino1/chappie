...
public class Sunflow extends SunflowAPI {
  public Sunflow() {
    Display display = new FileDisplay(false);
    // UI.printInfo(Module.BENCH, "Preparing benchmarking scene ...");
    // settings
    parameter("threads", 10); // threads);
    ...
    for (int i = 0; i < 25; i++) {
      ...
      // parameter("aa.samples", Chappie.check());
      System.out.println(Chappie.getProfile());
